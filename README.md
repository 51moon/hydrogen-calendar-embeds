...
> **Note:** If only one view is specified in `views`, `initial_view` will automatically be set to that view and does not need to be specified.
...
> **Note:** This can only be alphanumeric.
...
#### `fc_args` (EXPERIMENTAL)

JSON string that allows you to override or implement just about any FullCalendar argument (with some exceptions).

Example: `fc_args='{"weekNumbers":"true", "eventTextColor":"red"}'`
...
1. Hydrogen Calendar Embeds.
   ...
   <img src="assets-wp-repo/screenshot-1.png" height="400" />
&nbsp;
&nbsp;

2. List View.

   <img src="assets-wp-repo/screenshot-2.png" height="400" />
&nbsp;
&nbsp;

3. Optional Event Popover.

   <img src="assets-wp-repo/screenshot-3.png" height="400" />
&nbsp;
&nbsp;

4. Block Settings. It's that simple.

   <img src="assets-wp-repo/screenshot-4.png" height="200" />
&nbsp;
&nbsp;
...
With the `fc_args` parameter, you can pass in any FullCalendar argument to customize your calendar. See the [FullCalendar documentation](https://fullcalendar.io/docs) for a full list of options.
